...
public class ConfigManager {
    ...
    public static void init() {
        ...
        redstoneMI = builder.comment("Maximum amount of redstone a piggybank can generate in 1 day. Default is 2304 a day")
                .defineInRange("vanilla.redstone.max_interest", 2304, 0, 5184);
        goldIR = builder.comment("Interest rate of gold, 0 will give no interest, 1 will give 100% interest. Default is 0.012345679, 1 nugget per block")
                .defineInRange("vanilla.gold.interest_rate", 1/81f, 0, 1);
        goldMI = builder.comment("Maximum amount of gold nuggets a piggybank can generate in 1 day. Default is 20736 a day")
        ...
        lapisMI = builder.comment("Maximum amount of lapis a piggybank can generate in 1 day. Default is 2304 a day")
                .defineInRange("vanilla.lapis.max_interest", 2304, 0, 5184);
        emeraldIR = builder.comment("Interest rate of emerald, 0 will give no interest, 1 will give 100% interest. Default is 0.015625, 1 per stack")
                .defineInRange("vanilla.emerald.interest_rate", 1/64f, 0, 1);
        emeraldMI = builder.comment("Maximum amount of emerald a piggybank can generate in 1 day. Default is 2304 a day")
                .defineInRange("vanilla.emerald.max_interest", 2304, 0, 5184);
        diamondIR = builder.comment("Interest rate of diamond, 0 will give no interest, 1 will give 100% interest. Default is 0.0078125, 1 per 2 stacks")
                .defineInRange("vanilla.diamond.interest_rate", 1/128f, 0, 1);
        diamondMI = builder.comment("Maximum amount of diamond a piggybank can generate in 1 day. Default is 2304 a day")
        ...
        netheriteMI = builder.comment("Maximum amount of netherite a piggybank can generate in 1 day. Default is 2304 a day")
